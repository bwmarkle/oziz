...
(function ($) {
    $.deparam = function (params, coerce) {
        ...
        $.each(
            params.replace(/\+/g, ' ').split('&'), function (j, v) {
                var param = v.split('='),
    ...
    api.controlConstructor['repeatable'] = api.Control.extend(
        {
            ...
            conditionize: function ($context) {
                ...
                $context.on(
                    'change condition_check', 'input, select, textarea', function (e) {
            ...
            _init: function () {
                ...
                control.container.on(
                    'click', '.widget .widget-action, .widget .repeat-control-close, .widget-title', function (e) {
                        e.preventDefault();
                 ...
                 */
                control.container.on(
                    'click', '.repeat-control-remove', function (e) {
                        e.preventDefault();
                ...
                control.actions = function ($context) {
                    if (control.params.live_title_id) {
                        ...
                        if (control.params.live_title_id && $("[data-live-id='" + control.params.live_title_id + "']", $context).length > 0) {
                            ...
                            $context.on(
                                'keyup change', "[data-live-id='" + control.params.live_title_id + "']", function () {
                                    var v = '';
                 ...
                 */
                control.container.on(
                    'click', '.add-new-repeat-item', function () {
                ...
                $('.list-repeatable', control.container).on(
                    'keyup change color_change', 'input, select, textarea', function (e) {
                        control.updateValue();
                    }
                );
...
(function (api, $) {
    ...
    function _the_editor(container)
    {
        var _editor = {
            ...
            ready: function (container) {
                ...
                $('body').on(
                    'click', '#customize-controls, .customize-section-back', function (e) {
                    ...
                    $('textarea', control.editing_editor).attr('data-editor-mod', (control.editing_area.attr('data-editor-mod') || '')).wp_js_editor(
                        {
                            ...
                            init_instance_callback: function (editor) {
                                ...
                                w.on(
                                    'click', '.close-wp-editor', function (e) {
                                        e.preventDefault();
                                        control.editing_editor.removeClass('wpe-active');
                                        $('.wp-js-editor-preview').removeClass('wpe-focus');
                                    }
                                ...
                                w.on(
                                    'click', '.fullscreen-wp-editor', function (e) {
                                        e.preventDefault();
            ...
            _init: function () {
                ...
                control.container.on(
                    'click', '.wp-js-editor-preview', function (e) {
                        e.preventDefault();
                    }
                );
    ...
    api.bind(
        'ready', function (e, b) {
            ...
            $('#customize-theme-controls .accordion-section').each(
                function () {
                    var section = $(this);
                            ...
                            setTimeout(
                                function () {
                                    ...
                                    if ($('.repeatable-customize-control:not(.no-changeable) .item-editor', section).length > 0) {
                                        $('.repeatable-customize-control:not(.no-changeable) .item-editor', section).each(
                                            function () {
                                                _the_editor($(this));
                                            }
                                        );
            ...
            $('body').on(
                'repeater-control-init-item', function (e, container) {
                    $('.item-editor', container).each(
                        function () {
                            _the_editor($(this));
                        }
                    );
            ...
            $('body').on(
                'repeat-control-remove-item', function (e, container) {
...
jQuery(window).ready(
    function ($) {
         ...
         * For Video
        */
       $('select[data-customize-setting-link="youtube_home_background"]').on(
        'change on_custom_load', function () {
            var v = $(this).val() || '';
            switch (v) {
                case 'video':
                    $('#customize-control-youtube_home_bg_image').hide();
                    $('#customize-control-youtube_home_video_url').show();
                    $('#customize-control-youtube_home_video_mute').show();
                    
                break;
                case 'image':
                    $('#customize-control-youtube_home_bg_image').show();
                    $('#customize-control-youtube_home_video_url').hide();
                    $('#customize-control-youtube_home_video_mute').hide();
                break;
            }
        });

      
        $('select[data-customize-setting-link="youtube_home_background"').trigger('on_custom_load');
...
jQuery(document).ready(
    function ($) {
        ...
        $.each(
            C_Icon_Picker.fonts, function (key, font) {
                ...
                $.each(
                    icons_array, function (index, icon) {
                        if (font.prefix) {
        ...
        // Change icon type
        $('body').on(
            'change', 'select.c-icon-type', function () {
                var t = $(this).val();
        ...
        // When type to search
        $('body').on(
            'keyup', '.c-icon-search input', function () {
                var v = $(this).val();
                if (v == '') {
        ...
        // Remove icon
        $('body').on(
            'click', '.item-icon .remove-icon', function (e) {
                e.preventDefault();
        ...
        // Selected icon
        $('body').on(
            'click', '.c-icon-list span', function (e) {
                e.preventDefault();
